...
const lines = [
   ...
   lineData:{title: 'Filhos de Português', text: 
   ...
   lineData:{title: 'Netos de português', text: 
   ...
   lineData:{title: 'Bisnetos de português', text: 
   ...
   lineData:{title: 'Cidadania portuguesa pelo casamento ou pela união estável', text: 
