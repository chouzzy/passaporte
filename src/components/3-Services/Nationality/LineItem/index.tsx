...
export function LineItem({ LineImage, LineName, columns, lineData, changePage }: LineItemProps) {
   ...
   return (
      ...
      <GridItem w='100%' colSpan={columns} cursor='pointer'>
            <Link href='/nacionalidade-italiana'>
               <GridItem _hover={{ border: '1px solid #4ca7a1', transition: '400ms', boxShadow: 'dark-lg', color: 'gray.300' }} mx='auto' borderRadius={2} w='100%'
