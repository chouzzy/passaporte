...
export function Visa({changePage}: VisaProps) { 
   const linesBkp = [
      {image:'static/img/visa-1.jpg', 
       ...
       cols:[6,6,4,4], lineData:{title: 'Trabalhe legalmente em Portugal', 
       text:<Flex display='inline'>O Visto D1 é uma excelente oportunidade para aqueles que têm interesse em exercer atividade subordinada em Portugal, portando uma promessa de emprego formal ou contrato de trabalho assinado. <br></br> <br></br>  Existem algumas outras obrigações para aqueles que têm uma oportunidade de trabalho em Portugal, para além da necessidade de uma promessa de emprego e/ou de um contrato de trabalho. A obtenção do Visto D1 demanda a necessidade de anúncio, por parte da empresa contratante, da vaga no Instituto do Emprego e da Formação Profissional (IEFP). Este anúncio é de responsabilidade exclusiva da empresa, que deverá fornecer declaração de cumprimento deste fluxo.<br></br><br></br>
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}> Clique aqui para saber mais</Slink> </Text>
      <br></br><br></br>
      ...
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}> clique aqui e saiba mais sobre o Visto para busca de trabalho!</Slink> </Text>
      </Flex>,
      ...
      {image:'static/img/visa-2.jpg', 
       ...
       cols:[6,6,4,4], lineData:{title: 'Ideal para Empreendedores e Profissionais autônomos', 
      ...
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}>entre em contato conosco.</Slink> </Text>
      </Flex>,
      ...
      {image:'static/img/visa-3.jpg', 
       ...
       cols:[6,6,4,4], lineData:{title: 'Visto D3 - Ótima oportunidade para a obtenção do Cartão Azul europeu', 
      ...
      <br></br><br></br> Lembre-se, caso você não se encaixe nessa possibilidade, Portugal oferece agora outra excelente
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}> oportunidade para você.</Slink> </Text>
      </Flex>,
      ...
      {image:'static/img/visa-3.jpg', 
       ...
       cols:[6,6,3,3], lineData:{title: 'Visto D5 - Estudos em Portugal para estrangeiros já residentes na Europa', 
      ...
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}>entre em contato conosco!</Slink> </Text>
      <br></br><br></br>
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}>Caso você ainda esteja no Brasil, clique para saber mais sobre o visto D4.</Slink> </Text>
      </Flex>,
        serviceImage:'static/img/visa-3.jpg'}},
      {image:'static/img/visa-4.jpg', 
       name:<VStack> <Text>Visto D6</Text> <Text> Para estender os benefícios à família.</Text> </VStack>,
       cols:[6,6,3,3], lineData:{title: 'Visto D6 - Para estender os benefícios à família', 
      ...
      <Text display='inline' color='teal.500' fontWeight={'bold'} _hover={{color:'teal.600', transition:'400ms' , cursor:'pointer'}}> <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}> trabalhar por lá de maneira legal.</Slink> </Text>
      </Flex>,
        serviceImage:'static/img/visa-4.jpg'}},
      {image:'static/img/visa-3.jpg', 
       name:<VStack> <Text>Visto D7</Text> <Text> A tranquilidade para aposentados e titulares de rendimentos próprios.</Text> </VStack>,
       cols:[6,6,3,3], lineData:{title: 'Visto D7 - A tranquilidade para aposentados e titulares de rendimentos próprios', 
   ...
   const lines = [
      {image:'static/img/visa-1.jpg', 
       name:<VStack> <Text>Visto D1</Text> <Text>Trabalhe legalmente em Portugal</Text> </VStack>,
       cols:[6,6,4,4], lineData:{title: 'Visto D1: Trabalhe legalmente em Portugal', 
      ...
      {image:'static/img/visa-2.jpg', 
       name:<VStack> <Text>Visto D2</Text> <Text>Ideal para Empreendedores e Profissionais autônomos.</Text> </VStack>,
       cols:[6,6,4,4], lineData:{title: 'Visto D2: Ideal para Empreendedores e Profissionais autônomos', 
       text:<Flex display='inline'>O Visto D2 é o ideal para você que tem a vontade de ter seu próprio negócio em Portugal, empreendendo no país de modo a incentivar a economia local e gozar de todos os benefícios de ser um empreendedor em Portugal. Além disso, também podem solicitar o Visto D2 trabalhadores autônomos que tenham um contrato de trabalho ou proposta de emprego como profissional liberal em Portugal. Claro, além da vontade de empreender no país, é necessário comprovar algumas condições preliminares. Porém, não se preocupe, o Clube do Passaporte pode te ajudar com tudo isso!  <br></br><br></br>Para saber mais,{' '}
