    ...
    data: [
        {
            ...
            name: <VStack> <Text>Visto para procura de trabalho em Portugal.</Text> </VStack>,
            altName: 'Visto D8: para procura de trabalho em Portugal.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto para procura de trabalho em Portugal.',
                text:
                    <Flex display='inline'>
                        ...
                        <br></br><br></br>
                        Para saber mais,{' '}
                        <Flex display='inline' color='teal.500' fontWeight={'bold'} _hover={{ color: 'teal.600', transition: '400ms', cursor: 'pointer' }}>
        ...
        },
        {
            ...
            altName: 'Visto D1 Trabalhe legalmente em Portugal.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D1: Trabalhe legalmente em Portugal.',
                text:
                    <Flex display='inline'>
...

        {
            ...
            altName: 'Visto D2: Ideal para Empreendedores e Profissionais autônomos.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D2: Ideal para Empreendedores e Profissionais autônomos',
...

        {
            ...
            altName: 'Visto D3: Ideal para profissionais gabaritados.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D3: Ideal para profissionais gabaritados. ',
...

        {
            ...
            altName: 'Visto D5: Estudos em Portugal para estrangeiros já residentes na Europa.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D5: Estudos em Portugal para estrangeiros já residentes na Europa',
                text:
                    <Flex display='inline'>
                        O Visto D5 é perfeito para pessoas que estejam estudando em alguma instituição de ensino na Europa e queiram passar a estudar e residir em Portugal. É justamente o seu conceito que o diferencia do Visto D4, pois ele é aconselhável para estudantes do ensino superior que já residem e estudam em qualquer país membro da União Europeia legalmente há menos de dois anos e queiram transferir ou complementar seus estudos para Portugal. Assim como o D4, este Visto também permite o exercício de atividade profissional remunerada. <br></br> <br></br> Este visto é um  pouco diferente dos demais, uma , pois o solicitante deve já ser titular de uma autorização de residência ou de estudo concedida por um outro Estado membro da União Europeia. É uma modalidade de visto extremamente adequada para casos de intercâmbio dentro da Europa, dupla titulação e a chamada graduação sanduíche. <br></br><br></br> Caso você esteja estudando na Europa,{' '}
                        <Flex display='inline' color='teal.500' fontWeight={'bold'} _hover={{ color: 'teal.600', transition: '400ms', cursor: 'pointer' }}>
                            <Slink to={'#contato'} spy={true} smooth={true} offset={-60} duration={500}>
                                entre em contato conosco!
                            </Slink>
        ...
        },
        {
            ...
            altName: 'Visto D6: Para estender os benefícios à família.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D6: Para estender os benefícios à família',
                text:
                    <Flex display='inline'>
        ...
        },
        {
            ...
            altName: 'Visto D7: A tranquilidade para aposentados e titulares de rendimentos próprios.',
            cols: [6, 6, 3, 3],
            servicePageData: {
                mode: 'visa',
                title: 'Visto D7: A tranquilidade para aposentados e titulares de rendimentos próprios',
                text:
                    <Flex display='inline'>
